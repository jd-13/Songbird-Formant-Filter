    ...
    : CoreProcessorEditor(ownerFilter)
{
    ...
    MOD1Group->setBounds (72, 222, 280, 136);
    ...
    FilterPosSld->setBounds (124, 73, 184, 24);
    ...
    DepthMOD1Sld->setBounds (151, 284, 32, 24);
    ...
    FreqMOD1Sld->setBounds (92, 284, 32, 24);
    ...
    DepthMOD1Lbl->setBounds (139, 314, 54, 24);
    ...
    TempoNumerMOD1Sld->setBounds (78, 282, 56, 16);
    ...
    PhaseMOD1Lbl->setBounds (198, 314, 56, 24);
    ...
    OutputGainLbl->setBounds (270, 185, 88, 24);
    ...
    ENV1Group->setBounds (72, 362, 280, 88);
    ...
    AttackENV1Sld->setBounds (115, 389, 32, 24);
    ...
    ReleaseENV1Sld->setBounds (196, 389, 32, 24);
    ...
    AmountENV1Lbl->setBounds (262, 419, 64, 24);
    ...
    AirLbl->setBounds (195, 186, 36, 24);
    ...
    tooltipLbl->setBounds (40, 448, 344, 24);
...
void SongbirdAudioProcessorEditor::paint (juce::Graphics& g)
{
    ...
    g.drawImage(bg, 0, 0, 425, 475, 0, 0, 2 * 425, 2 * 475);
    //[/UserPaint]
}
...
<JUCER_COMPONENT documentType="Component" className="SongbirdAudioProcessorEditor"
                 ...
                 fixedSize="1" initialWidth="425" initialHeight="475">
  <BACKGROUND backgroundColour="ffffffff"/>
  <GROUPCOMPONENT name="MOD 1 Group" id="a2c7412d0fb46a58" memberName="MOD1Group"
                  virtualName="" explicitFocusOrder="0" pos="72 222 280 136" outlinecol="ffffdf5e"
                  textcol="ffffdf5e" title="LFO" textpos="36"/>
  <COMBOBOX name="Vowel 1 Combo Box" id="ab5acbd6ca836993" memberName="Vowel1Cmb"
            virtualName="" explicitFocusOrder="0" pos="60 73 48 24" tooltip="Vowel to apply in the left position"
  ...
  <SLIDER name="Filter Position Slider" id="1be87d051f6ceb97" memberName="FilterPosSld"
          ...
          explicitFocusOrder="0" pos="124 73 184 24" tooltip="Modulation position between the two vowels"
  ...
  <COMBOBOX name="Vowel 2 Combo Box" id="9ac26013f2f51695" memberName="Vowel2Cmb"
            virtualName="" explicitFocusOrder="0" pos="316 73 48 24" tooltip="Vowel to apply in the right position"
            editable="0" layout="33" items="A&#10;E&#10;I&#10;O&#10;U" textWhenNonSelected=""
            textWhenNoItems="(no choices)"/>
  <SLIDER name="Mix Slider" id="b75c053482d8ac35" memberName="MixSld" virtualName="WECore::JUCEPlugin::LabelReadoutSlider&lt;double&gt;"
          explicitFocusOrder="0" pos="75 126 72 56" tooltip="Dry/Wet mix level"
  ...
  <SLIDER name="MOD 1 Depth Slider" id="499f6451911662cc" memberName="DepthMOD1Sld"
          virtualName="WECore::JUCEPlugin::LabelReadoutSlider&lt;double&gt;"
          explicitFocusOrder="0" pos="151 284 32 24" tooltip="Depth of the LFO"
          min="0.0" max="1.0" int="0.01" style="RotaryVerticalDrag" textBoxPos="NoTextBox"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1.0"
          needsCallback="1"/>
  <SLIDER name="MOD 1 Freq Slider" id="1d9800ca18cf5bba" memberName="FreqMOD1Sld"
          virtualName="WECore::JUCEPlugin::LabelReadoutSlider&lt;double&gt;"
          explicitFocusOrder="0" pos="92 284 32 24" tooltip="Frequency of the LFO, from 2Hz to 20Hz"
          min="0.0" max="1.0" int="0.01" style="RotaryVerticalDrag" textBoxPos="NoTextBox"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1.0"
          needsCallback="1"/>
  <COMBOBOX name="MOD 1 Wave" id="370e5062e67cf738" memberName="WaveMOD1Cmb"
            virtualName="" explicitFocusOrder="0" pos="259 314 80 24" tooltip="Wave shape of the LFO"
            editable="0" layout="33" items="Sine&#10;Square&#10;Saw&#10;SC Comp"
            textWhenNonSelected="" textWhenNoItems="(no choices)"/>
  <LABEL name="MOD 1 Freq Label" id="dabfca26c640fd58" memberName="FreqMOD1Lbl"
         virtualName="" explicitFocusOrder="0" pos="80 314 56 24" textCol="ffffdf5e"
  ...
  <LABEL name="MOD 1 Depth Label" id="77092a4a55225c68" memberName="DepthMOD1Lbl"
         virtualName="" explicitFocusOrder="0" pos="139 314 54 24" textCol="ffffdf5e"
  ...
  <TEXTBUTTON name="MOD 1 Tempo Sync Button" id="b43affdb8ac7bb90" memberName="TempoSyncMOD1Btn"
              virtualName="" explicitFocusOrder="0" pos="83 250 54 16" tooltip="Enables tempo sync for the LFO"
  ...
  <SLIDER name="MOD 1 Tempo Denom Slider" id="a116d9c60bf4c7b5" memberName="TempoDenomMOD1Sld"
          virtualName="" explicitFocusOrder="0" pos="78 314 56 16" tooltip="Denominator for the LFO's tempo sync"
  ...
  <LABEL name="MOD 1 Phase Label" id="af1abf98d305cb5c" memberName="PhaseMOD1Lbl"
         virtualName="" explicitFocusOrder="0" pos="198 314 56 24" textCol="ffffdf5e"
  ...
  <TEXTBUTTON name="Mod Mode Button" id="82ccbd2e4873bcd5" memberName="ModModeBtn"
              virtualName="" explicitFocusOrder="0" pos="181 109 64 24" tooltip="Blends between both vowels in parallel or a frequency in between"
  ...
  <LABEL name="Mix Label" id="49736b42e5833ce0" memberName="MixLbl" virtualName=""
         explicitFocusOrder="0" pos="95 185 32 24" textCol="ffff8773"
  ...
  <SLIDER name="Output Gain Slider" id="69d51698f3b89634" memberName="OutputGainSld"
          virtualName="WECore::JUCEPlugin::LabelReadoutSlider&lt;double&gt;"
          explicitFocusOrder="0" pos="278 126 72 56" tooltip="Output gain"
          min="0.0" max="1.0" int="0.01" style="RotaryVerticalDrag" textBoxPos="NoTextBox"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1.0"
          needsCallback="1"/>
  <LABEL name="Output Gain Label" id="fe76b3e123fa3f5" memberName="OutputGainLbl"
         virtualName="" explicitFocusOrder="0" pos="270 185 88 24" textCol="ffff8773"
  ...
  <LABEL name="Filter Position Label" id="1b9fe7c323e1b093" memberName="FilterPosLbl"
         virtualName="" explicitFocusOrder="0" pos="190 48 46 24" textCol="ffff8773"
  ...
  <GENERICCOMPONENT name="MOD1 Wave View" id="3c0e47dfa5180365" memberName="WaveViewMOD1"
                    ...
                    pos="261 284 75 23" class="juce::Component" params=""/>
  <TEXTBUTTON name="MOD 1 Invert Button" id="395539a668deb434" memberName="InvertMOD1Btn"
              virtualName="" explicitFocusOrder="0" pos="271 250 56 16" tooltip="Inverts the LFO output"
  ...
  <GROUPCOMPONENT name="ENV 1 Group" id="1d76738168bbbf4a" memberName="ENV1Group"
                  virtualName="" explicitFocusOrder="0" pos="72 362 280 88" outlinecol="ffffdf5e"
                  textcol="ffffdf5e" title="ENV" textpos="36"/>
  <SLIDER name="ENV 1 Attack Slider" id="264aa0e56bd20789" memberName="AttackENV1Sld"
          virtualName="WECore::JUCEPlugin::LabelReadoutSlider&lt;double&gt;"
          explicitFocusOrder="0" pos="115 389 32 24" tooltip="Attack time of the envelope follower"
  ...
  <SLIDER name="ENV 1 RElease Slider" id="18435c1b5fc88e12" memberName="ReleaseENV1Sld"
          virtualName="WECore::JUCEPlugin::LabelReadoutSlider&lt;double&gt;"
          explicitFocusOrder="0" pos="196 389 32 24" tooltip="Release time of the envelope follower"
          min="0.0" max="1.0" int="0.001" style="RotaryVerticalDrag" textBoxPos="NoTextBox"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="0.6"
          needsCallback="1"/>
  <SLIDER name="ENV 1 Amount Slider" id="5f1616997a701625" memberName="AmountENV1Sld"
          virtualName="WECore::JUCEPlugin::LabelReadoutSlider&lt;double&gt;"
          explicitFocusOrder="0" pos="278 389 32 24" tooltip="Amount of envelope follower modulation"
          min="0.0" max="1.0" int="0.01" style="RotaryVerticalDrag" textBoxPos="NoTextBox"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1.0"
          needsCallback="1"/>
  <LABEL name="ENV 1 Attack Label" id="e2a626de44f6d7b7" memberName="AttackENV1Lbl"
         virtualName="" explicitFocusOrder="0" pos="104 419 54 24" textCol="ffffdf5e"
  ...
  <LABEL name="ENV 1 Release Label" id="126de3ff2ed85010" memberName="ReleaseENV1Lbl"
         virtualName="" explicitFocusOrder="0" pos="180 419 64 24" textCol="ffffdf5e"
  ...
  <LABEL name="ENV 1 Amount Label" id="2831f91f2dee16d4" memberName="AmountENV1Lbl"
         virtualName="" explicitFocusOrder="0" pos="262 419 64 24" textCol="ffffdf5e"
  ...
  <SLIDER name="Air Slider" id="81a06a78d96d563b" memberName="AirSld" virtualName="WECore::JUCEPlugin::LabelReadoutSlider&lt;double&gt;"
          explicitFocusOrder="0" pos="197 155 32 24" tooltip="Adds brightness using higher frequency formant filters"
          min="0.0" max="1.0" int="0.01" style="RotaryVerticalDrag" textBoxPos="NoTextBox"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1.0"
          needsCallback="1"/>
  <LABEL name="Air Label" id="648fc300fd08f461" memberName="AirLbl" virtualName=""
         explicitFocusOrder="0" pos="195 186 36 24" textCol="ffff8773"
  ...
  <LABEL name="Tooltip Label" id="37c38fbe0fd8f213" memberName="tooltipLbl"
         virtualName="" explicitFocusOrder="0" pos="40 448 344 24" textCol="ff9a9f50"
         edTextCol="ff000000" edBkgCol="0" labelText="" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="15.0" kerning="0.0" bold="0" italic="0" justification="36"/>
</JUCER_COMPONENT>
